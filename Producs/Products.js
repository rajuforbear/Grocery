import { View, Text, StyleSheet, TouchableOpacity, Image, TextInput, ImageBackground, ActivityIndicator } from 'react-native'
                    ...
                    renderItem={({ item }) => (
                        <View>
                            <View style={styles.list1}>
                                ...
                                <TouchableOpacity style={styles.cart} onPress={() => { NavFunction(item.product_id) }}>
